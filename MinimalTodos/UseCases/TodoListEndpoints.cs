...
namespace MinimalTodos.UseCases
{
    public static class TodoListEndpoints
    {
        public static IEndpointRouteBuilder AddTodoListEndpoints(this IEndpointRouteBuilder builder)
        {
            ...
            builder.MapPost("/todoList/{id}/todo", async (Guid id, CreateTodo.Request request, ISender sender, CancellationToken token) => await sender.Send(request with { ListId = id }, token))
